...
6. **Customer side:** dashboard stats + merchant cards; account detail with the warm-brown primary "سداد الآن"; permanent profile QR (c-qr, ID-only, drawn lazily once); profile/logout.
