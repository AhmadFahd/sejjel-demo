...
export const ar = {
  ...
  'link.share': 'إرسال رابط سداد بالواتساب',
  'link.title': 'رابط السداد',
  'link.to': 'إلى',
  'link.message':
    'مرحبًا {name} \u{1F44B}\nتذكير بمستحقك لدى {shop}: {amount}.\nيُستحق يوم {payday}، يوم السداد الموحد.\nادفع مباشرة من الرابط:\n{url}',
  'link.open': 'فتح واتساب بالرسالة الجاهزة',
  'link.preview': 'معاينة الصفحة كما يفتحها العميل',
  'link.close': 'إغلاق',
  'link.expires': 'صالح لمرة واحدة، حتى {date}.',
  'link.error.nothing': 'لا يوجد مستحق على هذا العميل.',
  'link.error.connection': 'هذا العميل ليس من عملائك.',

  'web.tagline': 'صفحة سداد سريعة — بلا تحميل تطبيق.',
  'web.claim': 'مستحق لـ {shop}',
  'web.due': 'تاريخ الاستحقاق {date}',
  'web.gateway': 'عبر بوابة الدفع (محاكاة هنا)',
  'web.note':
    'فتحت هذه الصفحة من الواتساب. لا حساب تفتحه ولا تطبيق تحمّله: ادفع، ثم أغلق الصفحة.',
  'web.paidTitle': 'تم السداد.',
  'web.paidBody': 'وصل تأكيد البوابة وأُشعر التاجر.',
  'web.amountPaid': 'المبلغ المدفوع',
  'web.expiredTitle': 'انتهت صلاحية هذا الرابط.',
  'web.expiredBody': 'اطلب من المتجر إرسال رابط جديد.',
  'web.alreadyTitle': 'سُدّد هذا الرابط.',
  'web.alreadyBody': 'لم يُخصم شيء مرة أخرى.',
  'web.changedTitle': 'تغيّر المبلغ.',
  'web.changedBody':
    'المستحق الآن أقل مما يطلبه هذا الرابط. اطلب من المتجر رابطًا جديدًا.',
  'web.failed':
    'لم تتم عملية الدفع. لم يُخصم شيء؛ حاول مرة أخرى أو استخدم وسيلة أخرى.',
